...
import {withDeadline,openCamera,waitForVideo,loadTarget} from './ar-session.js?v=29';
...
async function enter(preview){
  ...
  try{
    ...
    const trackerAssets=preview?null:Promise.all([
      withDeadline(import('./ar-mindar-image.prod.js'),25000,'RESOURCE_TIMEOUT',signal),
    ...
    const [T]=await Promise.all([
      withDeadline(import('./ar-three.module.min.js'),25000,'RESOURCE_TIMEOUT',signal),
