...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ws(){return new Wr({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ks(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Gs(){return new Wr({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ks(),fragmentShader:`
